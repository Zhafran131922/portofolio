...
import { FaFacebookF, FaInstagram, FaXTwitter, FaTiktok, FaDiscord, FaYoutube } from "react-icons/fa6";
...
Have something to discuss? Send me a message and let&apos;s talk.
      ...
      <div className="w-full md:w-[320px] bg-[#0c1123]/80 rounded-2xl p-6 shadow-xl border border-[#4dd0e1]/10 flex flex-col gap-4">
        ...
        {[
          { icon: <FaFacebookF />, label: "Zhafran Gopreto", platform: "Facebook" },
          { icon: <FaInstagram />, label: "rpradana10", platform: "Instagram" },
          { icon: <FaXTwitter />, label: "ZhafranR_", platform: "X" },
          { icon: <FaTiktok />, label: "zhafran131922", platform: "Tiktok" },
          { icon: <FaDiscord />, label: "zhafran131922", platform: "Discord" },
          ...
          >
            ...
            <div className="text-sm text-white leading-tight">
              ...
              <div className="text-[#c1f5ff]/60 text-xs">on {item.platform}</div>
            </div>
          </div>
        ))}
      </div>
