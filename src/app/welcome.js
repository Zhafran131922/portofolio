  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center w-full max-w-4xl">
        ...
        <h1 className="text-5xl md:text-6xl font-bold mb-2">Welcome To My</h1>
        ...
        <p className="text-lg md:text-xl text-[#c1f5ff] max-w-2xl mb-10">
          Frontend Developer specializing in React and Next.js with a passion
          for creating beautiful, performant user experiences.
        </p>
